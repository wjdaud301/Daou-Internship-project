...
rawData = pd.read_csv(f'/home/jmyeong/tarfile/web_log/{path}' ,sep=' ',header=None, names=columns)

rawData.reset_index(inplace = True)
del rawData["time"]
rawData.columns = columns
rawData["time"] = rawData["time"].apply(lambda x : x.replace("[",""))
rawData.to_csv(f'/home/jmyeong/tarfile/web_log/{path}',mode='w', header=False, index= False)
print('complete')
